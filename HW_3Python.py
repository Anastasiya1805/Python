...
item_1 = int_item + 10
#24. Сделать if в котором будет условие: если item_1 меньше comp_item, то вывести в консоль (“Переменная item_1 меньше”,
# comp_item), иначе, вывести в консоль (“Переменная item_1 больше или равна”, comp_item)
if item_1 < comp_item:
    print('Переменная item_1 меньше =', comp_item)
else item_1 > comp_item:
    print('Переменная item_1 больше или =', comp_item)
...
#29Создать переменную currency_convertor со значением item_2
currency_convertor = item_2

#30. Сделать if в котором будет условие: если currency_convertor, то выполнять следующие шаги задания, иначе, вывести в
...
if currency_convertor:
    ...
    if target_currency == 'eur':
        ...
        print('currency_result1 =', target_currency_amount, usd_item, '=', currency_result, eur_item)
        ...
        print('currency_result2 =', target_currency_amount, usd_item, '=', currency_result, uah_item)
    elif target_currency == 'chf':
        currency_result = target_currency_amount / usd_chf_rate
        print('currency_result3 =', target_currency_amount, usd_item, '=', currency_result, chf_item)
    elif target_currency == 'rub':
        currency_result = target_currency_amount / usd_rub_rate
        print('currency_resalt4 =', target_currency_amount, usd_item, '=', currency_result, rub_item)
    elif byn_item == 'byn':
        currency_result = target_currency_amount / usd_byn_rate
        print('currency_result5 =', target_currency_amount, usd_item, '=', currency_result, byn_item)
